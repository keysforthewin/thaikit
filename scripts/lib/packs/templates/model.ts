// Vendored from the vibe3d CLI package (npm "vibe3d" 0.0.1, MIT), templates/model.ts.
// vibe3d init writes this file into a consuming app; packs import it as @vibe3d/model.ts.
