/**
 * Toyota Commuter Van -- Vibe3D entry point.
 *
...
import {
  ...
  createToyotaCommuterVanLookDevLights,
  frameToyotaCommuterVanCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createToyotaCommuterVanLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameToyotaCommuterVanCamera(camera, root, {
      margin,
      elevationDeg,
