/**
 * AIS Shop Building -- Vibe3D entry point.
 *
...
import {
  ...
  createAISShopBuildingLookDevLights,
  frameAISShopBuildingCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createAISShopBuildingLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameAISShopBuildingCamera(camera, root, {
      margin,
      elevationDeg,
