/**
 * Expressway Gantry Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createExpresswayGantrySignLookDevLights,
  frameExpresswayGantrySignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createExpresswayGantrySignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameExpresswayGantrySignCamera(camera, root, {
      margin,
      elevationDeg,
