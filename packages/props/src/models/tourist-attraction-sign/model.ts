/**
 * Tourist Attraction Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createTouristAttractionSignLookDevLights,
  frameTouristAttractionSignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createTouristAttractionSignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameTouristAttractionSignCamera(camera, root, {
      margin,
      elevationDeg,
