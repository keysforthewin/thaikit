/**
 * U-Turn Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createUTurnSignLookDevLights,
  frameUTurnSignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createUTurnSignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameUTurnSignCamera(camera, root, {
      margin,
      elevationDeg,
