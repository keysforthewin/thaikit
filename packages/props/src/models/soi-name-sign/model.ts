/**
 * Soi Name Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createSoiNameSignLookDevLights,
  frameSoiNameSignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createSoiNameSignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameSoiNameSignCamera(camera, root, {
      margin,
      elevationDeg,
