/**
 * 7-Eleven Store Building -- Vibe3D entry point.
 *
...
import {
  ...
  create7ElevenStoreBuildingLookDevLights,
  frame7ElevenStoreBuildingCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = create7ElevenStoreBuildingLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frame7ElevenStoreBuildingCamera(camera, root, {
      margin,
      elevationDeg,
