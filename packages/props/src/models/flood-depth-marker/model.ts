/**
 * Flood Depth Marker -- Vibe3D entry point.
 *
...
import {
  ...
  createFloodDepthMarkerLookDevLights,
  frameFloodDepthMarkerCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createFloodDepthMarkerLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameFloodDepthMarkerCamera(camera, root, {
      margin,
      elevationDeg,
