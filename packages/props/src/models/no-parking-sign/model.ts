/**
 * No Parking Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createNoParkingSignLookDevLights,
  frameNoParkingSignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createNoParkingSignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameNoParkingSignCamera(camera, root, {
      margin,
      elevationDeg,
