/**
 * Elephant Crossing Sign -- Vibe3D entry point.
 *
...
import {
  ...
  createElephantCrossingSignLookDevLights,
  frameElephantCrossingSignCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createElephantCrossingSignLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameElephantCrossingSignCamera(camera, root, {
      margin,
      elevationDeg,
