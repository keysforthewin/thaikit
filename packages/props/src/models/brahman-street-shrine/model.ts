/**
 * Brahman Street Shrine -- Vibe3D entry point.
 *
...
import {
  ...
  createBrahmanStreetShrineLookDevLights,
  frameBrahmanStreetShrineCamera,
...
export function createPreview(options: PreviewOptions = {}): ModelPreview {
  ...
  const lights = createBrahmanStreetShrineLookDevLights('neutral');
  ...
  let elapsed = time;
  const aim = () => {
    frameBrahmanStreetShrineCamera(camera, root, {
      margin,
      elevationDeg,
