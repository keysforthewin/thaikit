...
/**
 * Curved Riverside Condo Tower — a skyline imposter.
 *
 * One upright quad carrying the asset's straight-on elevation plate, keyed to
 * alpha. Two triangles, one geometry, one material. It stands 180.000 m tall and
 * 93.500 m wide (height is the real building's; width follows the plate's keyed
