...
// scratch/slender-tower-with-gold-crown/src/createObjectModel.ts
...
function createObjectModel(_spec, options = {}) {
  ...
  root.name = "slender-tower-with-gold-crown";
