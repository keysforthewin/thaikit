...
// scratch/twin-office-towers-with-sky-bridge/src/createObjectModel.ts
...
function createObjectModel(_spec, options = {}) {
  ...
  root.name = "twin-office-towers-with-sky-bridge";
