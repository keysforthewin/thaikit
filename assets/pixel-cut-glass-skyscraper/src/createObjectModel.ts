...
/**
 * Pixel-Cut Glass Skyscraper — a skyline imposter.
 *
 * One upright quad carrying the asset's straight-on elevation plate, keyed to
 * alpha. Two triangles, one geometry, one material. It stands 314.000 m tall and
 * 59.600 m wide (height is the real building's; width follows the plate's keyed
