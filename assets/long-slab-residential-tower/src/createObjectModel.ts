...
/**
 * Long Slab Residential Tower — a skyline imposter.
 *
 * One upright quad carrying the asset's straight-on elevation plate, keyed to
 * alpha. Two triangles, one geometry, one material. It stands 90.000 m tall and
 * 110.000 m wide (height is the real building's; width follows the plate's keyed
